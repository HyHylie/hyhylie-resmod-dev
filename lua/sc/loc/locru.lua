...
Hooks:Add("LocalizationManagerPostInit", "ResMod_Ruloc_Weapons", function(loc)
	LocalizationManager:add_localized_strings({
		...
		--CUSTOM WEAPON ATTACHMENTS
					...
					["bm_wp_reflex2_desc"] = "Разновидность коллиматорного прицела.",
					["bm_wp_wpn_fps_ass_coyote_reflex_sight_mk2"] = "Коллиматорный прицел",
					["bm_wp_reflex2_desc"] = "Прицел с тонкими элементами, обеспечивающий максимальную видимость цели.",
					...
					["bm_wp_1x_scope_desc"] = "Разновидность коллиматорного прицела.",
					...
					["bm_w_senator_desc"] = "Сделан для патронов 3'', этот ствол имеет отличный боезапас 12+12+1.",
		...
		--CUSTOM ARs
			...
			--NV4
		          ...
		          ["bm_w_gauss_gun_desc"] = "Снайперская винтовка, использующая для разгона пули систему электромагнитов. Была разработана и используется исключительно внутри Зоны. В этом случае же, нет, не только.",
